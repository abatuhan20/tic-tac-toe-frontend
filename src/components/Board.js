...
const Board = ({result, setResult}) => {
    ...
    //Her change olduğunda trackliyo (boardda)
    useEffect(() => {
        checkIfTie();
        checkWin();
...
// Arrayin içini doldurmaca
            await channel.sendEvent({
                type:"game-move",
                data: { square, player },
            });
// useChannelStateContext sayesinde event yollayabiliyorum
...
//Yolladığım eventi dinliyorum eventin fonksiyona girmesi => çok önemli burada
